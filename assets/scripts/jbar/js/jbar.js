...
!function(window, $, undefined){
	...
	jBar.prototype = {
		...
		construct: function () {
            ...
            var oBar = $('.cUs_oSbr');
            var pushClass = 'jbar-push';
            var arrowTabClass = 'jbar-down-arrow';
            var arrowBarClass = 'jbar-up-arrow';
            if( oBar.hasClass( "_b0t" ) ){
                var pushClass = 'jbar-push_';
                var arrowTabClass = 'jbar-up-arrow';
                var arrowBarClass = 'jbar-down-arrow';
            }

            this.$elem.before(
                $('<div class="'+ pushClass +'"></div>' +
					'<a href="#" class="jbar-down-toggle">' +
					'<img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" class="'+ arrowTabClass +'" alt=""></a>')
			)
			this.$elem.append(
				$(
					'<div class="jbar-wrap"></div><a href="#" class="jbar-up-toggle">' +
					'<img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" class="' + arrowBarClass + '" alt=""></a>'
				)
			)
			return this
		},
