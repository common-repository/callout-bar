 ...
 * */
?>
<form method="post" action="admin.php?page=cUs_callout_bar_plugin" id="cUsSBr_selectable" class="cus_versionform select_version <?php echo (!strlen($cus_version) || $cus_version == 'tab') ? 'hidden' : ''; ?>" name="cUsSBr_selectable">
    ...
    <div class="pageselect_cont">
        ...
        if (is_array($mypages)) {
            ...
            $getInlinePages = get_option('cUsSBr_settings_inlinepages');
            ...
            <ul class="selectable_pages">
                ...
                <li class="ui-widget-content">
                    ...
                    <div class="options home">
                        ...
                        <label class="label-home setLabels" for="pageradio-home" title="Callout Bar Will show up in Home page">Enabled</label>
                    ...
                    <div class="form_template form-templates-home">
                        <h4>Pick which Bar/Form you would like on this page</h4>
                                ...
                                switch ($cUs_json->status) {
                                    case 'success':
                                        foreach ($cUs_json->data as $oForms => $oForm) {
                                            ...
                                            if (cUsSBr_allowedFormType($oForm->form_type)) {
                                                ...
                                                <span class="<?php echo $itemClass; ?> item template-home" rel="<?php echo $oForm->form_key ?>">
                                                    ...
                                                    <span class="captions">
                                                        <p>
                                                            Bar Name: <br/> <?php echo $oForm->form_name ?>
                                                        </p>
                                                    </span>
                ...
                foreach ($mypages as $page) {
                    ...
                    $pageSettings = get_post_meta($page->ID, 'cUsSBr_FormByPage_settings', false);
                    ...
                    <li class="ui-widget-content">
                        ...
                        <div class="form_template form-templates-<?php echo $page->ID; ?>">
                            <h4>Pick which Bar/Form combination you would like on <?php echo $page->post_title; ?> page</h4>
